...
namespace SW365.OSIRIS.TableModel
{
	...
	public partial class Appointment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SW365.OSIRIS.TableModel.AppointmentState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SW365.OSIRIS.TableModel.AppointmentState)(System.Enum.ToObject(typeof(SW365.OSIRIS.TableModel.AppointmentState), optionSet.Value)));
				}
				else
				{
					return null;
