...
namespace SW365.OSIRIS.TableModel
{
	...
	public partial class Appointment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string sw365_Incident = "sw365_incident";
			public const string sw365_Incident_Appointment = "sw365_Incident_Appointment";
			public const string sw365_IncidentName = "sw365_incidentname";
		...
		public virtual AppointmentState? StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((AppointmentState?)(EntityOptionSetEnum.GetEnum(this, "statecode")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sw365_incident")]
		public Microsoft.Xrm.Sdk.EntityReference sw365_Incident
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("sw365_incident");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sw365_Incident");
				this.SetAttributeValue("sw365_incident", value);
				this.OnPropertyChanged("sw365_Incident");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sw365_incidentname")]
		public string sw365_IncidentName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("sw365_incident"))
				{
					return this.FormattedValues["sw365_incident"];
				}
				else
				{
					return default(string);
		...
		public SW365.OSIRIS.TableModel.Account Account_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.Account>("Account_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Account_Appointments");
				this.SetRelatedEntity<SW365.OSIRIS.TableModel.Account>("Account_Appointments", null, value);
		...
		public SW365.OSIRIS.TableModel.Contact Contact_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.Contact>("Contact_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Contact_Appointments");
				this.SetRelatedEntity<SW365.OSIRIS.TableModel.Contact>("Contact_Appointments", null, value);
		...
		public SW365.OSIRIS.TableModel.Incident Incident_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.Incident>("Incident_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Incident_Appointments");
				this.SetRelatedEntity<SW365.OSIRIS.TableModel.Incident>("Incident_Appointments", null, value);
		...
		public SW365.OSIRIS.TableModel.SystemUser lk_appointment_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.SystemUser>("lk_appointment_createdby", null);
			}
		}
		...
		public SW365.OSIRIS.TableModel.SystemUser lk_appointment_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.SystemUser>("lk_appointment_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appointment_createdonbehalfby");
				this.SetRelatedEntity<SW365.OSIRIS.TableModel.SystemUser>("lk_appointment_createdonbehalfby", null, value);
		...
		public SW365.OSIRIS.TableModel.SystemUser lk_appointment_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.SystemUser>("lk_appointment_modifiedby", null);
			}
		}
		...
		public SW365.OSIRIS.TableModel.SystemUser lk_appointment_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.SystemUser>("lk_appointment_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		/// <summary>
		/// N:1 sw365_Incident_Appointment
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sw365_incident")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("sw365_Incident_Appointment")]
		public SW365.OSIRIS.TableModel.Incident sw365_Incident_Appointment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.Incident>("sw365_Incident_Appointment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sw365_Incident_Appointment");
				this.SetRelatedEntity<SW365.OSIRIS.TableModel.Incident>("sw365_Incident_Appointment", null, value);
		...
		public SW365.OSIRIS.TableModel.SystemUser user_appointment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SW365.OSIRIS.TableModel.SystemUser>("user_appointment", null);
			}
		}
