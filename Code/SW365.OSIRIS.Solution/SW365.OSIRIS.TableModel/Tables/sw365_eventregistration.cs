...
namespace SW365.OSIRIS.TableModel
{
	...
	public partial class sw365_eventregistration : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SW365.OSIRIS.TableModel.sw365_eventregistrationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SW365.OSIRIS.TableModel.sw365_eventregistrationState)(System.Enum.ToObject(typeof(SW365.OSIRIS.TableModel.sw365_eventregistrationState), optionSet.Value)));
				}
				else
				{
					return null;
