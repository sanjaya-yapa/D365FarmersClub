...
namespace SW365.OSIRIS.TableModel
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<SW365.OSIRIS.TableModel.TaskState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SW365.OSIRIS.TableModel.TaskState)(System.Enum.ToObject(typeof(SW365.OSIRIS.TableModel.TaskState), optionSet.Value)));
				}
				else
				{
					return null;
